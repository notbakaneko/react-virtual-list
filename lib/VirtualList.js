  ...
  return function (InnerComponent) {
    ...
    return _temp = _class = function (_PureComponent) {
      ...
      _createClass(vlist, [{
        ...
        value: function setStateIfNeeded(list, container, items, itemHeight, itemBuffer, columns) {
          // get first and lastItemIndex
          var state = (0, _getVisibleItemBounds2.default)(list, container, items, itemHeight, itemBuffer, columns);
